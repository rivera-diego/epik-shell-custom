...
try {
  ...
  console.error("AstalNotifd not available (possibly conflicting with Mako):", e);
}
    ...
    return (
      <Gtk.ScrolledWindow vexpand>
        ...
        >
          ...
          />
          <label label="Notification service unavailable" />
          <label label="(Possibly conflicting with Mako)" cssClasses={["subtitle"]} />
        </box>
      </Gtk.ScrolledWindow>
    );
  }
